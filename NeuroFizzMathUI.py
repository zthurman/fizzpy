...
class ApplicationWindow(QtGui.QMainWindow):
    ...
    def draw_FNcanvas(self):
        ...
        self.layout1 = QtGui.QHBoxLayout(self.tab2)
        self.hbox1 = QtGui.QVBoxLayout(self.tab2)
        ...
        self.hbox1.addWidget(self.param)
        self.hbox1.addWidget(self.paramEdit)
        self.hbox1.addWidget(self.param1)
        self.hbox1.addWidget(self.param1Edit)
        self.hbox1.addWidget(self.param2)
        self.hbox1.addWidget(self.param2Edit)
